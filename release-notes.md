python-dogecoinlib release notes
===============================

v0.4.0
======

Major fix: OpenSSL 1.0.1k rejects non-canonical DER signatures, which Dogecoin
...
* No longer assumes dogecoin.conf specifes rpcuser
...
attribute of the dogecoin.core.key module, and the entire dogecoin.core.bignum
...
* Improve dogecoin address handling. P2SH and P2PKH addresses now get their own
  classes - P2SHDogecoinAddress and P2PKHDogecoinAddress respectively - and P2PKH
...
'python-dogecoinlib-(version)', replacing the less specific '(version)' form
previously used.
