import socket, time, dogecoin
from dogecoin.messages import msg_version, msg_verack, msg_addr
...
# receive version message: /pythondogecoin0.0.1/: version 70002, blocks=-1, us=192.168.0.149:18333, them=192.168.0.13:18333, peer=192.168.0.13:39979
