# Copyright (C) 2012-2015 The python-dogecoinlib developers
#
...
is in dogecoin.core.scripteval
"""
...
class CScript(bytes):
    ...
    def __coerce_instance(cls, other):
        ...
        if isinstance(other, CScriptOp):
            ...
            if 0 <= other <= 16:
                ...
                other = CScriptOp.encode_op_pushdata(dogecoin.core._bignum.bn2vch(other))
    ...
    def __repr__(self):
        ...
        def _repr(o):
            if isinstance(o, bytes):
                return "x('%s')" % dogecoin.core.b2x(o)
            else:
                return repr(o)
    ...
    def to_p2sh_scriptPubKey(self, checksize=True):
        ...
        return CScript([OP_HASH160, dogecoin.core.Hash160(self), OP_EQUAL])
...
def RawSignatureHash(script, txTo, inIdx, hashtype):
    ...
    txtmp = dogecoin.core.CMutableTransaction.from_tx(txTo)
    ...
    if (hashtype & 0x1f) == SIGHASH_NONE:
        ...
        for i in range(outIdx):
            txtmp.vout.append(dogecoin.core.CTxOut())
